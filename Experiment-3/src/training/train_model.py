...
funcs = {'IAMPara': IAMPara, 'lenet': lenetFCN, 'fcn': FCN,
        'custom': customFCN, 'LineDetectModel': LineDetectModel}
...
def train(args, use_comet : bool = True):
    ...
    if use_comet and args['find_lr'] == False:
        ...
        with experiment.test():  
            loss = model.evaluate(dataset, int(args['batch_size']))
